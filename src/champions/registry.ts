...
const koenig: ChampionDef = {
  ...
  info: {
    ...
    q: { name: 'Boomerang Blade', desc: 'Hurl a spinning blade that flies out and back, cutting on both legs.' },
    e: { name: 'Royal Nova', desc: 'A golden shockwave knocks enemies back and empowers your next 3 attacks.' },
...
const yasuo: ChampionDef = {
  ...
  info: {
    ...
    q: { name: 'Steel Tempest', desc: 'A quick thrust; every third cast unleashes a tornado that knocks up and slows. Cooldown scales with attack speed.' },
...
const ashe: ChampionDef = {
  ...
  info: {
    ...
    q: { name: 'Volley', desc: 'Fire a fan of frost arrows that slow everything they hit.' },
    e: { name: 'Focus Fire', desc: 'Surge of attack speed for 3s; your frost bites harder while it lasts.' },
...
const garen: ChampionDef = {
  ...
  info: {
    ...
    q: { name: 'Decisive Strike', desc: 'Surge forward; your next attack lands like a hammer for bonus damage.' },
    e: { name: 'Judgment', desc: 'Spin your blades, dealing damage in a wide area around you as you move.' },
...
const jinx: ChampionDef = {
  ...
  info: {
    ...
    q: { name: 'Rocket', desc: 'Fire a rocket that explodes on impact, splashing damage around the target.' },
    e: { name: 'Zap!', desc: 'A fast bolt that heavily slows the first enemy hit.' },
...
const lux: ChampionDef = {
  ...
  info: {
    ...
    q: { name: 'Light Binding', desc: 'A piercing beam that roots the first two enemies it hits. Scales with ability power.' },
    e: { name: 'Lucent Bloom', desc: 'Mark the ground at your aim; after a beat it blooms, dealing area magic damage and slowing. Scales with ability power.' },
...
const darius: ChampionDef = {
  ...
  info: {
    ...
    q: { name: 'Decimate', desc: 'Sweep your axe in a wide circle, healing for each enemy champion struck.' },
    e: { name: 'Apprehend', desc: 'Rake the axe toward your aim, dragging enemies inward and slowing them.' },
...
const zed: ChampionDef = {
  ...
  info: {
    ...
    q: { name: 'Twin Shuriken', desc: 'Throw two shuriken that pierce every enemy in their path.' },
    e: { name: 'Shadow Leap', desc: 'Leave a taunting shadow, blink forward, and empower your attacks for 3s.' },
